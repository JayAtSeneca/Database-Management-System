...
--GROUP: 14
--GROUP MEMBER: Jay Pravinkumar Chaudhari, Yash Vipulkumar Shah, Bhavy Piyushkumar Patel
--NAME: Jay Pravinkumar Chaudhari
--STUDENT ID: 147268205
--EMAIL: jpchaudhari@myseneca.ca

--NAME: Yash Vipulkumar Shah
--STUDENT ID: 103985214
--EMAIL: yvshah@myseneca.ca

--NAME: Bhavya Piyushkumar Patel
...
VALUES ('17', 'ScotiaBank Downtown', 'Toronto', 'Ontario', 'YES');
INSERT INTO Branch (branch_id, branch_name, branch_city, branch_state, assets) 
VALUES ('18', 'ScotiaBank Brampton', 'Brampton', 'Ontario', 'NO');
INSERT INTO Branch (branch_id, branch_name, branch_city, branch_state, assets) 
VALUES ('32', 'ScotiaBank Scarborough West', 'Scarborough', 'Ontario', 'YES');
INSERT INTO Branch (branch_id, branch_name, branch_city, branch_state, assets) 
VALUES ('39', 'ScotiaBank Barrie', 'Barrie', 'Ontario', 'YES');
INSERT INTO Branch (branch_id, branch_name, branch_city, branch_state, assets) 
VALUES ('7', 'ScotiaBank Perrysound', 'PerrySound', 'Ontario', 'NO');
INSERT INTO Branch (branch_id, branch_name, branch_city, branch_state, assets) 
VALUES ('23', 'ScotiaBank Northyork', 'Northyork', 'Ontario',  'NO');
INSERT INTO Branch (branch_id, branch_name, branch_city, branch_state, assets) 
VALUES ('52', 'ScotiaBank Alberta', 'Calgary', 'Alberta',  'NO');
INSERT INTO Branch (branch_id, branch_name, branch_city, branch_state, assets) 
VALUES ('21', 'ScotiaBank Halifax', 'Halifax', 'NovoScotia', 'YES');
INSERT INTO Branch (branch_id, branch_name, branch_city, branch_state, assets) 
VALUES ('80', 'ScotiaBank Manitoba', 'Winnipeg', 'Manitoba', 'YES');
INSERT INTO Branch (branch_id, branch_name, branch_city, branch_state, assets) 
VALUES ('91', 'ScotiaBank NewBrunswick', 'Moncton', 'NewBrunswick','NO');
    SELECT * FROM dual;
    ...
    INSERT ALL 
     ...
     INTO customer (customer_id, customer_FName, customer_LName, customer_address, customer_city, customer_country, branch_id, account_number, loan_number)
       VALUES(11,'Mick', 'Harvey', '124 Captain America ','Toronto','Canada',21,2001,9011)
     INTO customer (customer_id, customer_FName, customer_LName, customer_address, customer_city, customer_country, branch_id, account_number, loan_number)
